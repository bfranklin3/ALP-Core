...
public interface HomeView extends View {
  ...
  public enum ActionType {
      NEW_HOME, NEW_SITE_PLAN, NEW_HOME_FROM_EXAMPLE, CLOSE, OPEN, DELETE_RECENT_HOMES, SAVE, SAVE_AS, SAVE_AND_COMPRESS,
      PAGE_SETUP, APPLY_DRAFT_OUTPUT_PRESET, APPLY_PRESENTATION_OUTPUT_PRESET,
      PRINT_PREVIEW, PRINT, PRINT_TO_PDF, PREFERENCES, EXIT,
      ...
      MOVE_BY_DISTANCE, REPLICATE_IN_LINE, FIT_COPIES_BETWEEN_POINTS,
      GROUP_FURNITURE, UNGROUP_FURNITURE, EXPORT_TO_CSV,
      SELECT, PAN, CREATE_WALLS, CREATE_ROOMS, CREATE_DIMENSION_LINES, MEASURE, CREATE_POLYLINES, CREATE_LABELS, DELETE_SELECTION,
      LOCK_BASE_PLAN, UNLOCK_BASE_PLAN, ENABLE_DRAFT_MODE, DISABLE_DRAFT_MODE, ENABLE_MAGNETISM, DISABLE_MAGNETISM, FLIP_HORIZONTALLY, FLIP_VERTICALLY,
      ...
      MAKE_LEVEL_ONLY_VIEWABLE_ONE, MAKE_ALL_LEVELS_VIEWABLE, MANAGE_LAYERS, MODIFY_LEVEL, MOVE_LAYER_UP, MOVE_LAYER_DOWN, DELETE_LEVEL,
      BRING_TO_FRONT, SEND_TO_BACK, BRING_FORWARD, SEND_BACKWARD,
      GROUP_PLAN_GRAPHICS, UNGROUP_PLAN_GRAPHICS, INCLUDE_WALL_OPENINGS,
      GROUP_PLAN_ASSEMBLY, UNGROUP_PLAN_ASSEMBLY,
